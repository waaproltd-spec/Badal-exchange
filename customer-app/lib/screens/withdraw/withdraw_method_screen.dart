...
class WithdrawMethodScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text(AppStrings.withdraw, style: AppTextStyles.title)),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _MethodTile(
                ...
                subtitle: 'Withdraw to your EVC Plus mobile money',
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const WithdrawDetailsScreen(method: 'evc_plus'),
                  ),
                ),
              ),
